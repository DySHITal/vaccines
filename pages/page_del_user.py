...
class PageDelete:
    def __init__(self, ui, statusBar, page_db):
        ...
        self.ui.bt_buscar_del.clicked.connect(partial(self.metodos_pacientes.buscar_por_nombre, self.ui.tabla_del, self.ui.line_nombre_del, self.ui.line_apellido_del))
